...
def heuristic(maxvehicles,production_machines,pmachinesperstage,jobs,roundtime,timebetweenmachines,schedule,duration,iterations):
    ...
    for vehicles in range(1,maxvehicles+1):
        ...
        for iteration in range(iterations):
            ...
            opening_solution = fcfs(vehicles,production_machines,pmachinesperstage,jobs,opening_sequence,roundtime,timebetweenmachines,schedule,duration)
                ...
                for i in range(vehicles):
                    ...
                    for j in range(0, roundtime):
                        if new_sequence[i,j] == 1:
                            ...
                            break
                    new_solution = fcfs(vehicles,production_machines,pmachinesperstage,jobs,new_sequence,roundtime,timebetweenmachines,schedule,duration)
