...
def heuristic(maxmachines,production_machines,pmachinesperstage,jobs,roundtime,timebetweenmachines,schedule,duration,iterations,pertubationjump):
    ...
    for machines in range(1,maxmachines+1):
        ...
        of the machines in the given iteration. Exception: the first machine is
        ...
        for iteration in range(iterations):
            ...
            all machinestartingtimes except for "0-starts" are moved to the front
            ...
            solution has a machines start at 0)
            """
            if iteration > 0:
            ...
            may change at a time. This leads to 2*machines as the size of the
        ...
        of time of the first schedule, and will therefore return a better goal
        """
        if machines > 2:
...
if __name__ == "__main__":
    #heuristic(maxmachines,production_machines,pmachinesperstage,jobs,roundtime,timebetweenmachines,schedule,duration,iterations,pertubationjump)
