...
import numpy as np
import math
from fcfs import fcfs, read_input
import time
                        ...
                        for f in range(e,roundtime):
                            for g in range(f,roundtime):
                                ...
                                for element in [a,b,c,d,e,f,g]:
                                    ...
                                    newtime[element] = 1
                                    startingtime.append(newtime)
                                if fcfs(maxmachines,production_machines,pmachinesperstage,jobs,startingtime,roundtime,timebetweenmachines,schedule,duration) < best_solution:
                                    best_solution = fcfs(maxmachines,production_machines,pmachinesperstage,jobs,startingtime,roundtime,timebetweenmachines,schedule,duration)
